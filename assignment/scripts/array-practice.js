...
let favoriteFoods = ['Macaroni', 'Spaghetti', 'Pho', 'Sushi', 'Curry'];
...
let dessert = 'mochi ice cream';
favoriteFoods.push(dessert);
console.log('And also my favorite dessert is', dessert);
...
let lastColor = colors[3];
colors.pop();
console.log('The colors in this list are:', colors);
...
console.log('The colors in the list are now:', colors);
